...
import (
	...
	"github.com/zircuit-labs/l2-geth/ethdb/pebble"
...
func testRepairWithScheme(t *testing.T, tt *rewindTest, snapshots bool, scheme string) {
	...
	// Zircuit addition: we do not freeze on finalization, so we use a different helper method
...
// TestIssue23496 tests scenario described in https://github.com/zircuit-labs/l2-geth/pull/23496#issuecomment-926393893
