...
func opSelfdestruct(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	if interpreter.evm.chainConfig.IsMonoFee(interpreter.evm.Context.BlockNumber, interpreter.evm.Context.Time) &&
		!interpreter.evm.chainConfig.IsTenrec(interpreter.evm.Context.Time) {
