...
import (
	...
	"github.com/zircuit-labs/l2-geth/crypto/blake2b"
	"github.com/zircuit-labs/l2-geth/crypto/bn256"
	"github.com/zircuit-labs/l2-geth/crypto/kzg4844"
	"github.com/zircuit-labs/l2-geth/crypto/secp256r1"
...
var PrecompiledContractsOsaka = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{0x06}): &bn256AddIstanbul{},
	common.BytesToAddress([]byte{0x07}): &bn256ScalarMulIstanbul{},
	common.BytesToAddress([]byte{0x08}): &bn256PairingGranite{},
	common.BytesToAddress([]byte{0x09}): &blake2F{},
	common.BytesToAddress([]byte{0x0a}): &kzgPointEvaluation{},
	common.BytesToAddress([]byte{0x0b}): &bls12381G1Add{},
	common.BytesToAddress([]byte{0x0c}): &bls12381G1MultiExpTenrec{},
	common.BytesToAddress([]byte{0x0d}): &bls12381G2Add{},
	common.BytesToAddress([]byte{0x0e}): &bls12381G2MultiExpTenrec{},
	common.BytesToAddress([]byte{0x0f}): &bls12381PairingTenrec{},
...
var PrecompiledContractsJavelina = map[common.Address]PrecompiledContract{
	common.BytesToAddress([]byte{0x01}): &ecrecover{},
	common.BytesToAddress([]byte{0x02}): &sha256hash{},
	common.BytesToAddress([]byte{0x03}): &ripemd160hash{},
	common.BytesToAddress([]byte{0x04}): &dataCopy{},
...
var PrecompiledContractsTenrec = map[common.Address]PrecompiledContract{
	common.BytesToAddress([]byte{1}):          &ecrecover{},
	common.BytesToAddress([]byte{2}):          &sha256hash{},
	common.BytesToAddress([]byte{3}):          &ripemd160hash{},
	common.BytesToAddress([]byte{4}):          &dataCopy{},
...
var (
	PrecompiledAddressesTenrec    []common.Address
	PrecompiledAddressesGranite   []common.Address
	PrecompiledAddressesFjord     []common.Address
	PrecompiledAddressesJavelina  []common.Address
...
func init() {
	for k := range PrecompiledContractsTenrec {
		PrecompiledAddressesTenrec = append(PrecompiledAddressesTenrec, k)
	}
	...
	for k := range PrecompiledContractsJavelina {
		PrecompiledAddressesJavelina = append(PrecompiledAddressesJavelina, k)
	}
...
func ActivePrecompiles(rules params.Rules) []common.Address {
	...
	case rules.IsTenrec:
		return PrecompiledAddressesTenrec
	case rules.IsOptimismGranite:
		return PrecompiledAddressesGranite
	case rules.IsOptimismFjord:
		return PrecompiledAddressesFjord
	case rules.IsJavelina:
		return PrecompiledAddressesJavelina
	case rules.IsPrague:
...
type bls12381G1MultiExpTenrec struct{}

func (c *bls12381G1MultiExpTenrec) RequiredGas(input []byte) uint64 {
	return new(bls12381G1MultiExpPrague).RequiredGas(input)
}

func (c *bls12381G1MultiExpTenrec) Run(input []byte) ([]byte, error) {
	if len(input) > int(params.Bls12381G1MulMaxInputSizeTenrec) {
...
// bls12381G1MultiExpPrague implements EIP-2537 G1MultiExp precompile.
...
type bls12381G2MultiExpTenrec struct{}

func (c *bls12381G2MultiExpTenrec) RequiredGas(input []byte) uint64 {
	return new(bls12381G2MultiExpPrague).RequiredGas(input)
}

func (c *bls12381G2MultiExpTenrec) Run(input []byte) ([]byte, error) {
	if len(input) > int(params.Bls12381G2MulMaxInputSizeTenrec) {
...
type bls12381PairingTenrec struct{}

func (c *bls12381PairingTenrec) RequiredGas(input []byte) uint64 {
	return new(bls12381PairingPrague).RequiredGas(input)
}

func (c *bls12381PairingTenrec) Run(input []byte) ([]byte, error) {
	if len(input) > int(params.Bls12381PairingMaxInputSizeTenrec) {
