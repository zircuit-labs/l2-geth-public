...
func TestUpdateLeaks(t *testing.T) {
	...
	state, _ := New(types.EmptyLegacyTrieRootHash, NewDatabaseWithNodeDB(db, tdb), nil)
...
func TestIntermediateLeaks(t *testing.T) {
	...
	transState, _ := New(types.EmptyLegacyTrieRootHash, NewDatabaseWithNodeDB(transDb, transNdb), nil)
	finalState, _ := New(types.EmptyLegacyTrieRootHash, NewDatabaseWithNodeDB(finalDb, finalNdb), nil)
...
// https://github.com/zircuit-labs/l2-geth-public/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(types.EmptyLegacyTrieRootHash, NewDatabase(rawdb.NewMemoryDatabase()), nil)
...
// See https://github.com/zircuit-labs/l2-geth-public/pull/15225#issuecomment-380191512
...
//
// See https://github.com/zircuit-labs/l2-geth-public/issues/20106.
func TestCopyCommitCopy(t *testing.T) {
	tdb := NewDatabase(rawdb.NewMemoryDatabase())
	state, _ := New(types.EmptyLegacyTrieRootHash, tdb, nil)
...
func testMissingTrieNodes(t *testing.T, scheme string) {
	...
	state, _ := New(types.EmptyLegacyTrieRootHash, db, nil)
	addr := common.BytesToAddress([]byte("so"))
	{
		state.SetBalance(addr, uint256.NewInt(1))
...
func TestFlushOrderDataLoss(t *testing.T) {
	...
	var (
		...
		state, _ = New(types.EmptyLegacyTrieRootHash, statedb, nil)
	)
	for a := byte(0); a < 10; a++ {
...
func TestResetObject(t *testing.T) {
	var (
		...
		snaps, _ = snapshot.New(snapshot.Config{CacheSize: 10}, disk, tdb, types.EmptyLegacyTrieRootHash)
		state, _ = New(types.EmptyLegacyTrieRootHash, db, snaps)
