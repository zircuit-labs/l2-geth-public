...
import (
	...
	"github.com/zircuit-labs/l2-geth/common/lru"
	"github.com/zircuit-labs/l2-geth/common/mclock"
	...
	"github.com/zircuit-labs/l2-geth/core/history"
	"github.com/zircuit-labs/l2-geth/core/rawdb"
	"github.com/zircuit-labs/l2-geth/core/state"
	"github.com/zircuit-labs/l2-geth/core/state/snapshot"
	...
	"github.com/zircuit-labs/l2-geth/internal/syncx"
	"github.com/zircuit-labs/l2-geth/internal/version"
...
func NewBlockChain(db ethdb.Database, genesis *Genesis, engine consensus.Engine, cfg *BlockChainConfig) (*BlockChain, error) {
	...
	chainConfig, genesisHash, genesisErr := SetupGenesisBlockWithOverride(db, triedb, genesis, cfg.Overrides)
...
func (bc *BlockChain) processBlock(parentRoot common.Hash, block *types.Block, setHead bool, makeWitness bool) (_ *blockProcessingResult, blockEndErr error) {
	...
	if witness := statedb.Witness(); witness != nil && bc.cfg.VmConfig.StatelessSelfValidation {
		...
		// task := types.NewBlockWithHeader(context).WithBody(block.Body().Transactions,block.Body().Uncles).WithWithdrawals(block.Body().Withdrawals)
...
func (bc *BlockChain) collectLogs(b *types.Block, removed bool) []*types.Log {
	...
	l1Info := rawdb.ReadL1Info(bc.db, b.Hash())
	receipts := rawdb.ReadRawReceipts(bc.db, b.Hash(), b.NumberU64())
	if err := receipts.DeriveFields(bc.chainConfig, b.Hash(), b.NumberU64(), b.Time(), b.BaseFee(), blobGasPrice, b.Transactions(), l1Info); err != nil {
...
// GetChainConfig gets the blockchain configuration
