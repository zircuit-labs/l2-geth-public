...
var (
	...
	// L1 Info
	l1InfoPrefix = []byte("l1info") // l1InfoPrefix + hash -> l1 info by block
...
// l1InfoKey = l1InfoPrefix + hash
func l1InfoKey(hash common.Hash) []byte {
	return append(l1InfoPrefix, hash.Bytes()...)
}
