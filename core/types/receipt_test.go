...
func TestTypedReceiptEncodingDecoding(t *testing.T) {
	payload := common.FromHex("")
...
func getOptimismTxReceipts(
	...
	l1GasPrice, l1GasUsed *big.Int, feeScalar *big.Float, l1Fee *big.Int,
) ([]*Transaction, []*Receipt) {
	// to4 := common.HexToAddress("0x4")
	// Create a few transactions to have receipts for
	txs := Transactions{
...
func TestDeriveOptimismBedrockTxReceipts(t *testing.T) {
	...
	baseFee := big.NewInt(1000)
	derivedReceipts := clearComputedFieldsOnReceipts(receipts)
	err := Receipts(derivedReceipts).DeriveFields(bedrockGenesisTestConfig, blockHash, blockNumber.Uint64(), 0, baseFee, nil, txs, nil)
	if err != nil {
		t.Fatalf("DeriveFields(...) = %v, want <nil>", err)
	}
	...
	err = Receipts(derivedReceipts).DeriveFields(ecotoneTestConfig, blockHash, blockNumber.Uint64(), 0, baseFee, nil, txs, nil)
	if err != nil {
		t.Fatalf("DeriveFields(...) = %v, want <nil>", err)
	}
	checkBedrockReceipts(t, receipts, derivedReceipts)
...
func TestDeriveOptimismIsthmusTxReceipts(t *testing.T) {
	...
	txs, receipts := getOptimismIsthmusTxReceipts(payload, baseFee, blobBaseFee, ecotoneGas, ecotoneFee, &baseFeeScalarUint64, &blobBaseFeeScalarUint64, &operatorFeeScalarUint64, &operatorFeeConstantUint64)
	...
	err = Receipts(derivedReceipts).DeriveFields(isthmusTestConfig, blockHash, blockNumber.Uint64(), 0, baseFee, nil, txs, nil)
	if err != nil {
		t.Fatalf("DeriveFields(...) = %v, want <nil>", err)
	}
	diffReceipts(t, receipts, derivedReceipts)
...
func TestDeriveOptimismIsthmusTxReceiptsNoOperatorFee(t *testing.T) {
	...
	baseFeeScalarUint64 := baseFeeScalar.Uint64()
	blobBaseFeeScalarUint64 := blobBaseFeeScalar.Uint64()
	txs, receipts := getOptimismIsthmusTxReceipts(payload, baseFee, blobBaseFee, ecotoneGas, ecotoneFee, &baseFeeScalarUint64, &blobBaseFeeScalarUint64, nil, nil)
