...
char* apply_tx(uint64_t id, char *tx_traces, char *proof_traces, char *code_traces);
char* apply_block(uint64_t id, char *block_trace, char *proof_traces, char *code_traces);
