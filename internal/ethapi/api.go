...
import (
	...
	"github.com/zircuit-labs/l2-geth-public/accounts/scwallet"
	...
	"github.com/zircuit-labs/l2-geth-public/eth/gasestimator"
...
//
// https://github.com/zircuit-labs/l2-geth-public/wiki/Management-APIs#personal_sign
...
//
// https://github.com/zircuit-labs/l2-geth-public/wiki/Management-APIs#personal_ecRecover
...
func (s *BlockChainAPI) GetProof(ctx context.Context, address common.Address, storageKeys []string, blockNrOrHash rpc.BlockNumberOrHash) (*AccountResult, error) {
	log.Warn("Got a call to GetProof", "address", address, "storageKeys", storageKeys, "blockNrOrHash", blockNrOrHash)
	...
	if len(keys) > 0 {
		...
		for i, key := range keys {
			...
			storageProof[i] = StorageResult{outputKey, value, toHexSlice(proof)}
		}
	}
	...
	if statedb.IsZktrie() {
		log.Debug("ZKTrie logic will be used to get account proof")
...
func (s *BlockChainAPI) extendBlockRpc(rpcBlock map[string]interface{}) {
...
//   - Adds L1Info.
func (s *BlockChainAPI) GetBlockByNumberEx(ctx context.Context, number rpc.BlockNumber, fullTx bool) (map[string]interface{}, error) {
...
//   - Adds L1Info.
func (s *BlockChainAPI) GetBlockByHashEx(ctx context.Context, hash common.Hash, fullTx bool) (map[string]interface{}, error) {
...
func (s *BlockChainAPI) GetCode(ctx context.Context, address common.Address, blockNrOrHash rpc.BlockNumberOrHash) (hexutil.Bytes, error) {
	log.Warn("Got a call to GetCode", "address", address, "blockNrOrHash", blockNrOrHash)
...
func (s *TransactionAPI) GetTransactionReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
	...
	if err != nil && !errors.Is(err, ErrSLSDisabled) {
		return nil, NewSLSError()
	}

	if result != nil && result.IsQuarantined && result.Quarantine != nil {
		return nil, NewSLSQuarantineError(result.Quarantine.QuarantinedReason, result.Quarantine.QuarantinedBy)
	}
