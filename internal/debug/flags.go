...
var (
	...
	logForceColorFlag = &cli.BoolFlag{
		Name:     "log.forcecolor",
		Usage:    "Force colorized logging",
		Value:    false,
		Category: flags.LoggingCategory,
	}
...
func Setup(ctx *cli.Context) error {
	...
	case logFmtFlag == "", logFmtFlag == "terminal":
		useColor := ((ctx.Bool(logForceColorFlag.Name) || isatty.IsTerminal(os.Stderr.Fd()) || isatty.IsCygwinTerminal(os.Stderr.Fd())) && os.Getenv("TERM") != "dumb")
		if useColor {
