...
func (c Config) MarshalTOML() (interface{}, error) {
	...
	enc.OverrideZircuitAlfie = c.OverrideZircuitAlfie
	enc.OverrideMonoFee = c.OverrideMonoFee
	enc.SLSConfig = c.SLSConfig
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.OverrideZircuitAlfie != nil {
		c.OverrideZircuitAlfie = dec.OverrideZircuitAlfie
	}
	if dec.OverrideMonoFee != nil {
		c.OverrideMonoFee = dec.OverrideMonoFee
	}
	if dec.SLSConfig != nil {
		c.SLSConfig = *dec.SLSConfig
	}
