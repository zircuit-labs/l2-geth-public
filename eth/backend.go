...
import (
	...
	"github.com/zircuit-labs/l2-geth-public/core/state/pruner"
	...
	"github.com/zircuit-labs/l2-geth-public/eth/protocols/eth"
	"github.com/zircuit-labs/l2-geth-public/eth/protocols/snap"
	...
	"github.com/zircuit-labs/l2-geth-public/internal/shutdowncheck"
	...
	"github.com/zircuit-labs/l2-geth-public/p2p/dnsdisc"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	if config.CCCConfig.Enabled {
		tracer := tracing.NewTracerWrapper(eth.blockchain)
		eth.blockchain.Validator().SetupTracerAndCircuitCapacityChecker(tracer, config.CCCConfig)
	}
	...
	legacyPool := legacypool.New(config.TxPool, eth.blockchain, eth.config.SLSConfig)
	...
	eth.miner = miner.New(eth, &config.Miner, eth.blockchain.Config(), eth.EventMux(), eth.engine, eth.isLocalBlock, config.CCCConfig)
...
func (s *Ethereum) Protocols() []p2p.Protocol {
	...
	if !params.ZKTrieEnabled.Load() && s.config.SnapshotCache > 0 {
