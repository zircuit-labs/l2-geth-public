...
import (
	...
	_ "github.com/zircuit-labs/l2-geth/eth/tracers/live"
)
...
func TestSupplyOmittedFields(t *testing.T) {
	var config = *params.MergedTestChainConfig
	...
	expected := supplyInfo{
		Number:     0,
		Hash:       common.HexToHash("0x2143109d7103923bf683151566c996edcabf0e94c4a2ea8d119eedfd3179621c"),
