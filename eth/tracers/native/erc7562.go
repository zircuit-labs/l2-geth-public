...
import (
	...
	"github.com/zircuit-labs/l2-geth/eth/tracers/internal"
	"github.com/zircuit-labs/l2-geth/log"
	"github.com/zircuit-labs/l2-geth/params"
)

//go:generate go tool gencodec -type callFrameWithOpcodes -field-override callFrameWithOpcodesMarshaling -out gen_callframewithopcodes_json.go
