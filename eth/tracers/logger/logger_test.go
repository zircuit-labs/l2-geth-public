...
func makeTestState() *state.StateDB {
	...
	stateDb, err := state.New(types.EmptyLegacyTrieRootHash, db, nil)
	if err != nil {
		panic(err)
	}
	return stateDb
...
func TestStoreCapture(t *testing.T) {
	var (
		...
		env      = vm.NewEVM(vm.BlockContext{}, vm.TxContext{}, makeTestState(), params.TestChainConfig, vm.Config{Tracer: logger})
...
// logs bloat and confusion. See https://github.com/zircuit-labs/l2-geth-public/issues/24487
