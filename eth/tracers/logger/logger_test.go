...
func TestStoreCapture(t *testing.T) {
	...
	evm_interpreter := vm.NewEVMInterpreter(evm)
	_, err := evm_interpreter.Run(contract, []byte{}, false)
	if err != nil {
		t.Fatal(err)
	}
...
// logs bloat and confusion. See https://github.com/zircuit-labs/l2-geth/issues/24487
