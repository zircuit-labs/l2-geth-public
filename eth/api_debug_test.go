...
func TestAccountRange(t *testing.T) {
	...
	var (
		...
		sdb, _  = state.New(types.EmptyLegacyTrieRootHash, statedb, nil)
...
func TestEmptyAccountRange(t *testing.T) {
	...
	var (
		...
		st, _   = state.New(types.EmptyLegacyTrieRootHash, statedb, nil)
	)
...
func TestStorageRangeAt(t *testing.T) {
	...
	var (
		...
		sdb, _ = state.New(types.EmptyLegacyTrieRootHash, db, nil)
