...
var (
	...
	unknownBlock = types.NewBlock(&types.Header{Root: types.EmptyLegacyTrieRootHash, GasLimit: params.GenesisGasLimit, BaseFee: big.NewInt(params.InitialBaseFee)}, nil, nil, nil, trie.NewStackTrie(nil))
)
