...
func TestAddressHexChecksum(t *testing.T) {
	tests := []struct {
		...
		// Test cases from https://github.com/zircuit-labs/EIPs/blob/master/EIPS/eip-55.md#specification
...
func TestMixedcaseAccount_Address(t *testing.T) {
	// https://github.com/zircuit-labs/EIPs/blob/master/EIPS/eip-55.md
...
func BenchmarkPrettyDuration(b *testing.B) {
	x := PrettyDuration(time.Duration(int64(1203123912312)))
