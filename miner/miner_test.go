...
func createMiner(t *testing.T) (*Miner, *event.TypeMux, func(skipMiner bool)) {
	...
	pool := legacypool.New(testTxPoolConfig, blockchain, sls.DisabledConfig)
	...
	// Create Miner
	miner := New(backend, &config, chainConfig, mux, engine, nil, circuitcapacitychecker.Config{Enabled: true})
