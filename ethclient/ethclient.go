...
func (ec *Client) BlockByHashEx(ctx context.Context, hash common.Hash) (*BlockEx, error) {
	return ec.getBlockEx(ctx, "eth_getBlockByHashEx", hash, true)
}
...
func (ec *Client) BlockByNumberEx(ctx context.Context, number *big.Int) (*BlockEx, error) {
	return ec.getBlockEx(ctx, "eth_getBlockByNumberEx", toBlockNumArg(number), true)
}
...
func (ec *Client) getBlock(ctx context.Context, method string, args ...any) (*types.Block, error) {
	blockEx, err := ec.getBlockEx(ctx, method, args...)
	if err != nil {
		return nil, err
	}
	return blockEx.Block, nil
}

func (ec *Client) getBlockEx(ctx context.Context, method string, args ...any) (*BlockEx, error) {
