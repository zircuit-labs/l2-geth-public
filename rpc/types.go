...
type API struct {
	...
	Protector     protector // func to be executed to validate the API signature.
}

type protector interface {
	IsSignatureValid(ctx context.Context, method string, args []any, signature string) (common.Address, bool)
}
