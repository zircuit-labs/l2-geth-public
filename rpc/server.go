...
// RegisterNameWithProtector same as RegisterName, but with a Protector.
func (s *Server) RegisterNameWithProtector(name string, receiver interface{}, protector protector) error {
	return s.services.registerName(name, receiver, protector)
}
