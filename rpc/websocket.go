...
func wsHandshakeValidator(allowedOrigins []string) func(*http.Request) bool {
	origins := collections.NewSet[string]()
	...
	log.Debug(fmt.Sprintf("Allowed origin(s) for WS RPC interface %v", origins.Members()))
...
func originIsAllowed(allowedOrigins collections.Set[string], browserOrigin string) bool {
	for origin := range allowedOrigins.Iter() {
