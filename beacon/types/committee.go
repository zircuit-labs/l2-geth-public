...
// https://github.com/zircuit-labs/consensus-specs/blob/dev/specs/altair/beacon-chain.md#syncaggregate
...
//go:generate go tool gencodec -type SyncAggregate -field-override syncAggregateMarshaling -out gen_syncaggregate_json.go
