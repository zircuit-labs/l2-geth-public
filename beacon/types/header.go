...
import (
	...
	"github.com/zircuit-labs/l2-geth/beacon/merkle"
	"github.com/zircuit-labs/l2-geth/beacon/params"
	"github.com/zircuit-labs/l2-geth/common"
)

//go:generate go tool gencodec -type Header -field-override headerMarshaling -out gen_header_json.go
...
// https://github.com/zircuit-labs/consensus-specs/blob/dev/specs/phase0/beacon-chain.md#beaconblockheader
type Header struct {
	...
	// SSZ hash of the beacon state (https://github.com/zircuit-labs/consensus-specs/blob/dev/specs/bellatrix/beacon-chain.md#beacon-state)
	StateRoot common.Hash `gencodec:"required" json:"state_root"`

	// SSZ hash of the beacon block body (https://github.com/zircuit-labs/consensus-specs/blob/dev/specs/bellatrix/beacon-chain.md#beaconblockbody)
...
//   - https://github.com/zircuit-labs/consensus-specs/blob/dev/specs/altair/light-client/sync-protocol.md#lightclientoptimisticupdate
