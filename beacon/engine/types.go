...
type RejectedPayloadMeta struct {
	TxsRejectedByCCC []common.Hash `json:"txsRejectedByCCC"`
}
...
func BlockToExecutableData(block *types.Block, fees *big.Int, sidecars []*types.BlobTxSidecar, l1Info *types.L1Info) *ExecutionPayloadEnvelope {
	data := &ExecutableData{
