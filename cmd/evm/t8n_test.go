...
import (
	...
	"github.com/zircuit-labs/l2-geth/cmd/evm/internal/t8ntool"
	"github.com/zircuit-labs/l2-geth/internal/cmdtest"
	"github.com/zircuit-labs/l2-geth/internal/reexec"
)
...
func TestT8n(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		// skip test, makes use of blobhash opcode
		// { // Cancun tests
		// 	base: "./testdata/28",
		// 	input: t8nInput{
