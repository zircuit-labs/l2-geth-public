...
const (
	ipcAPIs  = "admin:1.0 clique:1.0 debug:1.0 engine:1.0 eth:1.0 miner:1.0 net:1.0 rpc:1.0 txpool:1.0 web3:1.0 zirc:1.0"
	httpAPIs = "eth:1.0 net:1.0 rpc:1.0 web3:1.0 zirc:1.0"
...
func TestAttachWelcome(t *testing.T) {
	...
	t.Run("ws", func(t *testing.T) {
		...
		waitForEndpoint(t, endpoint, 3*time.Second)
		testAttachWelcome(t, geth, endpoint, wsAPIs)
	})
	geth.Kill()
}
