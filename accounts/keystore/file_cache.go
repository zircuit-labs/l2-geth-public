...
type fileCache struct {
	all     collections.Set[string] // Set of all files from the keystore folder
...
func (fc *fileCache) scan(keyDir string) (collections.Set[string], collections.Set[string], collections.Set[string], error) {
	t0 := time.Now()
	...
	mods := collections.NewSet[string]()
