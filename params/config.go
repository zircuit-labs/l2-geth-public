...
var (
	...
	ZircuitTestnetGenesisHash = common.HexToHash("0x1fbd857dd0d57f7178d5ba64012307cf50003633b464eaca215b279b5994101c")
	ZircuitMainnetGenesisHash = common.HexToHash("0x8500cf54183cec3749819985286df1ecfbd06999fe78ad19d3c3fbdbc34f07bd")
)
...
var (
	...
	// Zircuit networks
	ZircuitTestnetChainConfig = &ChainConfig{
		...
		FjordTime:                     newUint64(1754920800),
		GraniteTime:                   newUint64(1754920800),
		HoloceneTime:                  newUint64(1754920800),
		TenrecTime:                    newUint64(1754920800),
		OsakaTime:                     newUint64(1762869600),
		TerminalTotalDifficulty:       big.NewInt(0),
		TerminalTotalDifficultyPassed: true,
	...
	ZircuitMainnetChainConfig = &ChainConfig{
		ChainID:                       big.NewInt(48900),
		HomesteadBlock:                big.NewInt(0),
		EIP150Block:                   big.NewInt(0),
		EIP155Block:                   big.NewInt(0),
		EIP158Block:                   big.NewInt(0),
		...
		CanyonTime:                    newUint64(0),
		EcotoneTime:                   newUint64(0),
		CancunTime:                    newUint64(1741726801),
		MonoFeeBlock:                  big.NewInt(10895293),
		AlfieTime:                     newUint64(1745330400),
		IsthmusTime:                   newUint64(1747065600),
		PragueTime:                    newUint64(1747065600),
		JavelinaTime:                  newUint64(1750341600),
		FjordTime:                     newUint64(1756130401),
		GraniteTime:                   newUint64(1756130401),
		HoloceneTime:                  newUint64(1756130401),
		TenrecTime:                    newUint64(1756130401),
		OsakaTime:                     newUint64(1765202401),
		TerminalTotalDifficulty:       big.NewInt(0),
		TerminalTotalDifficultyPassed: true,
		Optimism: &OptimismConfig{
			EIP1559Elasticity:        10,
...
var NetworkNames = map[string]string{
	...
	ZircuitTestnetChainConfig.ChainID.String(): "zircuit-testnet",
	ZircuitMainnetChainConfig.ChainID.String(): "zircuit-mainnet",
}
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/zircuit-labs/EIPs/issues/150)
	...
	// MonoFeeBlock to pay fees to coinbase on state transition, not persisted in DB
	MonoFeeBlock *big.Int `json:"monoFeeBlock,omitempty"`
	...
	AlfieTime    *uint64 `json:"alfieTime,omitempty"`    // Alfie switch time (nil = no fork, 0 = already on)
	IsthmusTime  *uint64 `json:"isthmusTime,omitempty"`  // Isthmus switch time (nil = no fork, 0 = already on zircuit (not equal to Optimism's) isthmus)
...
func (s ScrollConfig) String() string {
	...
	return fmt.Sprintf("{maxTxPerBlock: %v, MaxTxPayloadBytesPerBlock: %v}",
		maxTxPerBlock, maxTxPayloadBytesPerBlock)
}
...
func (c *ChainConfig) Description() string {
	...
	banner += fmt.Sprintf(" - Homestead:                   #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/homestead.md)\n", c.HomesteadBlock)
	if c.DAOForkBlock != nil {
		banner += fmt.Sprintf(" - DAO Fork:                    #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/dao-fork.md)\n", c.DAOForkBlock)
	}
	banner += fmt.Sprintf(" - Tangerine Whistle (EIP 150): #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/tangerine-whistle.md)\n", c.EIP150Block)
	banner += fmt.Sprintf(" - Spurious Dragon/1 (EIP 155): #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/spurious-dragon.md)\n", c.EIP155Block)
	banner += fmt.Sprintf(" - Spurious Dragon/2 (EIP 158): #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/spurious-dragon.md)\n", c.EIP155Block)
	banner += fmt.Sprintf(" - Byzantium:                   #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/byzantium.md)\n", c.ByzantiumBlock)
	banner += fmt.Sprintf(" - Constantinople:              #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/constantinople.md)\n", c.ConstantinopleBlock)
	banner += fmt.Sprintf(" - Petersburg:                  #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/petersburg.md)\n", c.PetersburgBlock)
	banner += fmt.Sprintf(" - Istanbul:                    #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/istanbul.md)\n", c.IstanbulBlock)
	if c.MuirGlacierBlock != nil {
		banner += fmt.Sprintf(" - Muir Glacier:                #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/muir-glacier.md)\n", c.MuirGlacierBlock)
	}
	banner += fmt.Sprintf(" - Berlin:                      #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/berlin.md)\n", c.BerlinBlock)
	banner += fmt.Sprintf(" - London:                      #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/london.md)\n", c.LondonBlock)
	if c.ArrowGlacierBlock != nil {
		banner += fmt.Sprintf(" - Arrow Glacier:               #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/arrow-glacier.md)\n", c.ArrowGlacierBlock)
	}
	if c.GrayGlacierBlock != nil {
		banner += fmt.Sprintf(" - Gray Glacier:                #%-8v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/gray-glacier.md)\n", c.GrayGlacierBlock)
	}
	if c.MonoFeeBlock != nil {
		banner += fmt.Sprintf(" - Monofee (Garfield):          #%-8v\n", c.MonoFeeBlock)
	}
	banner += "\n"
	...
	if c.TerminalTotalDifficulty == nil {
		...
		banner += " - Hard-fork specification: https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/paris.md\n"
	} else {
	...
	if c.ShanghaiTime != nil {
		banner += fmt.Sprintf(" - Shanghai:                    @%-10v (https://github.com/zircuit-labs/execution-specs/blob/master/network-upgrades/mainnet-upgrades/shanghai.md)\n", *c.ShanghaiTime)
	}
	if c.CancunTime != nil {
	...
	if c.TenrecTime != nil {
		banner += fmt.Sprintf(" - Tenrec:                      @%-10v\n", *c.TenrecTime)
	}
	if c.JavelinaTime != nil {
		banner += fmt.Sprintf(" - Javelina:                    @%-10v\n", *c.JavelinaTime)
	}
	return banner
}
...
// IsMonoFee returns whether num is either equal to the Mono Fee fork block or greater.
func (c *ChainConfig) IsMonoFee(num *big.Int, time uint64) bool {
	return isBlockForked(c.MonoFeeBlock, num) && !isTimestampForked(c.TenrecTime, time)
}
...
func (c *ChainConfig) IsTenrec(time uint64) bool {
	return isTimestampForked(c.TenrecTime, time)
}

func (c *ChainConfig) IsAlfie(time uint64) bool {
	return isTimestampForked(c.AlfieTime, time)
}

func (c *ChainConfig) IsJavelina(time uint64) bool {
	return isTimestampForked(c.JavelinaTime, time)
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "monoFeeBlock", block: c.MonoFeeBlock, optional: true},
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, headNumber *big.Int, headTimestamp uint64) *ConfigCompatError {
	...
	if isForkBlockIncompatible(c.MonoFeeBlock, newcfg.MonoFeeBlock, headNumber) {
		return newBlockCompatError("MonoFee fork block", c.MonoFeeBlock, newcfg.MonoFeeBlock)
	}
...
func (c *ChainConfig) Rules(num *big.Int, isMerge bool, timestamp uint64) Rules {
	...
	return Rules{
		...
		IsJavelina:       isMerge && c.IsJavelina(timestamp),
		// Optimism
